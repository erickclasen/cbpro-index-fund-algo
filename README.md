...
Basically is using a Dual Moving Average Crossover (DMAC). Where if the short
...
- This code requires a backlog of price/volume data to operate properly.
  ...
  data is available. It will just do nothing until those build up.

<u>TBD: Paper Describing The Theory and Testing of the Dual Moving Average Ensemble</u>
...
and order is for 100 sell it will set a limit order at 100.1 and conversely
...
summary-0583fb-index-balancer.py.log
...
verbose-0583fb-index-balancer.py-buy-USDC.log

verbose-0583fb-index-balancer.py-buy-USD.log

verbose-0583fb-index-balancer.py-sell-USDC.log
