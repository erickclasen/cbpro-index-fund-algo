#!/usr/bin/python
#title			:cbpro_buy_sell.py
#description	:This code is a thin layer between the operating code that 
# performs the trading logic and the Coinbase Pro API.
# Provides other utility such as high limit and logging of transactions.
# reading accounts and calculation of price/size and setting limits and floor
# on the limit orders, sets the precision of price and size.

#author			:Erick Clasen
#date			:20210822
#version		:0.1
#usage			: Imported into operating code
# Has a mode that allows testing by calling this code directly, see MAIN section
...
def buy_lim(auth_client,product_label,currency,underlying,currency_price_list,scaled_buy_trade_amount,currency_avail):
        ...
        if (currency == 'OGN' and underlying == 'BTC') or (currency == 'SKL' and underlying == 'BTC') or (currency == 'GRT' and underlying == 'BTC') or (currency == 'KNC' and underlying == 'BTC') or ( currency == 'XLM' and underlying == 'BTC'): # Do to the floating point math can't do a lim order, default to mkt order here.
...
def sell_lim(auth_client,product_label,currency,underlying,currency_price_list,scaled_sell_trade_amount,currency_avail,unit_multiplier=1):
        ...
        if (currency == 'OGN' and underlying == 'BTC') or (currency == 'SKL' and underlying == 'BTC') or (currency == 'GRT' and underlying == 'BTC') or (currency == 'STORJ' and underlying == 'BTC') or (currency == 'ANKR' and underlying == 'BTC') or  (currency == 'NKN' and underlying == 'BTC') or (currency == 'MATIC' and underlying == 'BTC') or (currency == 'ADA' and underlying == 'BTC') or (currency == 'ZRX' and underlying == 'BTC') or (currency == 'FIL' and underlying == 'BTC') or (currency == 'NU' and underlying == 'BTC') or (currency == 'KNC' and underlying == 'BTC') or ( currency == 'XLM' and underlying == 'BTC') or (currency == 'OMG' and underlying == 'BTC'):  # Do to the floating point math can't do a lim order, default to mkt order here.
...
def cbpro_read_available(key,b64secret,passphrase):
...
def cbpro_read_holds(key,b64secret,passphrase):
...
def calculate_trade_size_and_price(currency,currency_price,trade_amount,currency_avail=None,underlying='USD'):
  ...
  # Testing these slight pushouts that should move the limit orders slightly out of range, so that they
    ...
    if currency == 'ZRX' or currency == 'BNT' or currency == 'ALGO' or currency == 'OXT' or currency == 'LRC' or currency == 'REN': # USD ONLY
            # Whole unit Min.
            size_accuracy = 0
            size_floor = 1
            ...
            if underlying == 'USD' or underlying == 'USDC':
                    ...
                    price_accuracy = 8 # For LRC only

    elif currency == 'CGLD' or currency == 'KNC' or currency == 'OMG' or currency == 'ADA' or currency == 'BAL' or currency == 'NKN' or currency == 'STORJ':
            # Whole unit Min.
    ...
    elif currency == 'XRP' or currency == 'NU' or currency == 'GRT':
            ...
            if underlying == 'USD' or underlying == 'USDC' or underlying == 'ETH': # ETH is for MANA.
                price_accuracy = 6
            else:
                price_accuracy = 8
    elif currency == 'ATOM' or currency == 'BAND':
            ...
            if underlying == 'USD' or underlying == 'USDC':
                ...
                price_accuracy = 6 #8
    elif currency == 'NMR' or currency == 'UMA':
            ...
            size_accuracy = 3 # 3 for etc 
            size_floor = 0.1 # ATOM is 0.1 floor 0.1 for etc
            if underlying == 'USD' or underlying == 'USDC':
                price_accuracy = 3
            else:
                price_accuracy = 6 #8
            ...
            if underlying == 'USD' or underlying == 'USDC':
                ...
                price_accuracy = 6 #8
    elif currency == 'BTC' or currency == 'YFI':   # Size to three, prices to 2 places.
            ...
            size_accuracy = 1 # I think this is OK
            size_floor = 5
            if underlying == 'USD' or underlying == 'USDC':
                price_accuracy = 3
            else:
            ...
            size_accuracy = 0 # I think this is OK
            size_floor = 10
            if underlying == 'USD' or underlying == 'USDC':
                price_accuracy = 5
            else:
...
def cbpro_limit_order_gtt(auth_client,side,f_price,f_size,product_label='BTC-USD',cncl_aftr='hour'):
    '''Place a limit order by specifying price of asset and size to sell. 
       Alternatively, `size` could be used to specify quantity in BTC amount.'''
