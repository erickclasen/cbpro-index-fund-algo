...
#date			:20210822
#version		:0.1
#usage			:python index-balancer.py key b64secret passphrase
#notes			:
...
for asset in asset_dict:
        ...
        idx_target_f = idx_target * risk_scaling(price_list_of_dicts,asset_dict)[asset]
        #print(idx_target_f)
        print()
